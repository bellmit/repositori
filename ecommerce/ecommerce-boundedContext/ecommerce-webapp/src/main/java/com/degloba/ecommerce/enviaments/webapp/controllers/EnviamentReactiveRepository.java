...
@Repository
public class EnviamentReactiveRepository implements IEnviamentReactiveRepository {
	...
	public Flux<Enviament> findAll() {
		...
		template.save(new Enviament("122", "2", "5")).subscribe(); 
	 ...
	 * static {
	 * 
	 * enviamentData = new HashMap<>(); enviamentData.put((long) 1,new
	 * Enviament("1", "1", "EstatEnviament.SENT")); enviamentData.put((long) 2,new
	 * Enviament("1", "2", "EstatEnviament.SENT")); enviamentData.put((long) 3,new
	 * Enviament("1", "3", "EstatEnviament.SENT")); enviamentData.put((long) 4,new
	 * Enviament("1", "4", "EstatEnviament.SENT")); enviamentData.put((long) 5,new
	 * Enviament("1", "5", "EstatEnviament.SENT")); enviamentData.put((long) 6,new
	 * Enviament("1", "6", "EstatEnviament.SENT")); enviamentData.put((long) 7,new
	 * Enviament("1", "7", "EstatEnviament.SENT")); enviamentData.put((long) 8,new
	 * Enviament("1", "8", "EstatEnviament.SENT")); }
	 */
