...
public class StoredEventTest {
	...
	/*
	 * @Test public void toDomainEvent() { instance =
	 * StoredDomainEvent.fromDomainEvent(event); DomainEventSub event1 =
	 * instance.toDomainEvent(); assertThat(event1.getId(), is(event.getId()));
	 ...
	 * 
	 * @Test public void fromDomainEvent() { instance =
	 * StoredDomainEvent.fromDomainEvent(event); assertThat(instance.getEventId(),
	 * is(event.getId())); assertThat(instance.getOccurredOn(),
	 * is(event.getOccurredOn())); assertThat(instance.getTypeName(),
	 * is(event.getClass().getName())); assertThat(instance.getEventBody(),
	 * is("theEventBody")); }
	 */
